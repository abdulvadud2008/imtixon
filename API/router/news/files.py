...
async def update_file(
    ...
    old_file_path = os.path.join(MEDIA_ROOT, post_files.file)
    ...
    post_files.file = file_data['file_dir'] + file.filename
    session.commit()
    session.refresh(post_files)
...
async def delete_file(
    ...
    file_path = os.path.join(MEDIA_ROOT, post_files.file)
